...
| `BROKER_STATE_SCREENSHOT_SIZE` | `640` | Longest side, in pixels, of the frame captured with a state. The capture is the whole streamed desktop, scaled down before it is served as the thumbnail. |
